...
1. **Корректность клиентского сегмента**
  1. Описывает конкретных людей (физических лиц), а не организации или абстракции
  2. Описывает длящееся состояние, а не событие из прошлого (тест "ЯВЛЯЕТСЯ")
  3. Критерии сегмента позволяют идентифицировать и достичь представителей (есть способ их найти и до них дотянуться)
  4. Не содержит элементов мотивационного конфликта (драйверов, барьеров, желаний)
...
4. **Корректность Атрибутов**
  1. Присутствуют уникальные атрибуты (таких, которых нет у категории и/или конкурентов)
...
- Атрибуты действительно разрешают конфликт одним из типовых способов ([[dkcp-motivational-conflict-resolve]])
