...
4. **Корректность Атрибутов**
    ...
    2. Атрибуты соответствуют своему типу (цепочка, мастерская, сеть)
    3. Атрибуты сформулированы как конкретные свойства (составных частей) или конкретные функции (составных частей)
