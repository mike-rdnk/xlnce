...
3. **Важно:** Обнови путь к материалам xlnce в файле правила:
   - Если xlnce находится в `_shared/public/xlnce/` → путь уже правильный
   - Если структура другая → укажи правильный относительный путь от корня проекта
...
Подробнее о структуре материалов см. файл `ИНСТРУКЦИИ-ДЛЯ-ИИ.md` в корне репозитория.